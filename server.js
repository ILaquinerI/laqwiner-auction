...
function weightedPick(){ const a=state.tanks.filter(t=>t.alive&&t.amount>0); const total=a.reduce((s,t)=>s+t.amount,0); let r=Math.random()*total; for(const t of a){r-=t.amount;if(r<=0)return t} return a[a.length-1]; }
